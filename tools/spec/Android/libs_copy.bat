...
xcopy /s/e/y/r/h "%PROJ_PATH%\build\intermediates\bundles\default\jni\*.so" "%ZF_ROOT_PATH%\_release\Android\module\%PROJ_NAME%\libs\libs" >nul 2>&1
...
if %JAR_FILE_SIZE% gtr 1024 (
    echo f | xcopy /s/e/y/r/h "%PROJ_PATH%\build\intermediates\bundles\default\classes.jar" "%ZF_ROOT_PATH%\_release\Android\module\%PROJ_NAME%\libs\%PROJ_NAME%.jar" >nul 2>&1
)
