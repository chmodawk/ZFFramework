...
protected:
    ...
    zfoverride
    virtual void pageAniOnUpdatePriority(ZF_IN ZFUIPageBasic *resumePageOrNull,
                                         ZF_IN ZFUIPageBasic *pausePageOrNull,
                                         ZF_IN zfbool pausePageHasHigherPriority)
    {
        zfsuper::pageAniOnUpdatePriority(resumePageOrNull, pausePageOrNull, pausePageHasHigherPriority);

        ZFUIWidget_ZFUIPage_test_Page *pageTmp = zfnull;
