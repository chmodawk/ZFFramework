...
ifeq ($(OS),Windows_NT)
    ...
    $(info $(shell call $(ZF_ROOT_PATH)\tools\spec\Android\res_copy.bat $(ZF_ROOT_PATH)\ZF\ZFLua\zfres assets\zfres >nul 2>&1))
    $(info $(shell call $(ZF_ROOT_PATH)\tools\spec\Android\res_copy.bat $(ZF_ROOT_PATH)\ZF\ZFUIWebKit\zfres assets\zfres >nul 2>&1))
    ...
    $(info $(shell call $(ZF_ROOT_PATH)\tools\spec\Android\res_copy.bat $(ZF_ROOT_PATH)\ZF\ZFLua_impl\zfres assets\zfres >nul 2>&1))
    $(info $(shell call $(ZF_ROOT_PATH)\tools\spec\Android\res_copy.bat $(ZF_ROOT_PATH)\ZF\ZFUIWebKit_impl\zfres assets\zfres >nul 2>&1))
else
    ZF_ROOT_PATH = ../../../../../ZFFramework
    ...
    $(info $(shell sh $(ZF_ROOT_PATH)/tools/spec/Android/res_copy.sh $(ZF_ROOT_PATH)/ZF/ZFLua/zfres assets/zfres >/dev/null 2>&1))
    $(info $(shell sh $(ZF_ROOT_PATH)/tools/spec/Android/res_copy.sh $(ZF_ROOT_PATH)/ZF/ZFUIWebKit/zfres assets/zfres >/dev/null 2>&1))
    ...
    $(info $(shell sh $(ZF_ROOT_PATH)/tools/spec/Android/res_copy.sh $(ZF_ROOT_PATH)/ZF/ZFLua_impl/zfres assets/zfres >/dev/null 2>&1))
    $(info $(shell sh $(ZF_ROOT_PATH)/tools/spec/Android/res_copy.sh $(ZF_ROOT_PATH)/ZF/ZFUIWebKit_impl/zfres assets/zfres >/dev/null 2>&1))
endif
