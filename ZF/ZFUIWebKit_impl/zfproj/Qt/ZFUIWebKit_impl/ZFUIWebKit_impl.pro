...
macx {QMAKE_POST_LINK += install_name_tool -change "libZFAlgorithm.1.dylib" "@rpath/libZFAlgorithm.dylib" $$system_path($$OUT_PWD/lib$${ZF_PROJ_NAME}.dylib) $$escape_expand(\\n\\t)}
LIBS += -L$$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/all/lib -lZFUtility
macx {QMAKE_POST_LINK += install_name_tool -change "libZFUtility.1.dylib" "@rpath/libZFUtility.dylib" $$system_path($$OUT_PWD/lib$${ZF_PROJ_NAME}.dylib) $$escape_expand(\\n\\t)}
LIBS += -L$$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/all/lib -lZFUIKit
macx {QMAKE_POST_LINK += install_name_tool -change "libZFUIKit.1.dylib" "@rpath/libZFUIKit.dylib" $$system_path($$OUT_PWD/lib$${ZF_PROJ_NAME}.dylib) $$escape_expand(\\n\\t)}
LIBS += -L$$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/all/lib -lZFUIWebKit
macx {QMAKE_POST_LINK += install_name_tool -change "libZFUIWebKit.1.dylib" "@rpath/libZFUIWebKit.dylib" $$system_path($$OUT_PWD/lib$${ZF_PROJ_NAME}.dylib) $$escape_expand(\\n\\t)}
