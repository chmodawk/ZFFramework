...
#define ZFCORE_PARAM_RETAIN_WITH_INIT(T_ParamType, paramName, initValue) \
    ...
    private: \
        ...
        public: \
            ...
            { \
                ...
                zflockfree_ZFLeakTestLogAfterRetainVerbose(this->value, ZFCallerInfo(ZF_CALLER_FILE, #paramName zfTextA(" init"), ZF_CALLER_LINE)); \
                zfCoreMutexUnlock(); \
                zfdelete(t); \
            } \
            ...
            { \
                ...
                zflockfree_ZFLeakTestLogAfterRetainVerbose(this->value, ZFCallerInfo(ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE)); \
                zfCoreMutexUnlock(); \
            } \
            ~paramName##_ZFCoreParam(void) \
            { \
                zfCoreMutexLock(); \
                zflockfree_ZFLeakTestLogBeforeReleaseVerbose(this->value, ZFCallerInfo(ZF_CALLER_FILE, #paramName zfTextA(" cleanup"), ZF_CALLER_LINE)); \
            ...
            { \
                ...
                zflockfree_ZFLeakTestLogAfterRetainVerbose(ref.value, ZFCallerInfo(ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE)); \
                zflockfree_ZFLeakTestLogBeforeReleaseVerbose(this->value, ZFCallerInfo(ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE)); \
                zflockfree_zfReleaseWithoutLeakTest(this->value); \
                zfCoreMutexUnlock(); \
    ...
    public: \
        ...
        { \
            ...
            zflockfree_ZFLeakTestLogAfterRetainVerbose(value, ZFCallerInfo(ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE)); \
            zflockfree_ZFLeakTestLogBeforeReleaseVerbose(this->paramName##_.value, ZFCallerInfo(ZF_CALLER_FILE, #paramName zfTextA("Set"), ZF_CALLER_LINE)); \
...
#define _ZFP_ZFCORE_PARAM_RETAIN_DEFINE(T_Owner, T_ParamType, paramName, initValue) \
    ...
    { \
        ...
        zfCoreMutexLock(); \
        this->value = zflockfree_zfRetainWithoutLeakTest(*(t = zfnew(T_ParamType, initValue))); \
        zflockfree_ZFLeakTestLogAfterRetainVerbose(this->value, ZFCallerInfo(this->_callerFile(), #paramName zfTextA(" init"), this->_callerLine())); \
        zfCoreMutexUnlock(); \
        zfdelete(t); \
    } \
    ...
    { \
        zfCoreMutexLock(); \
        this->value = zflockfree_zfRetainWithoutLeakTest(ref.value); \
        ZFLeakTestLogAfterRetainVerbose(this->value, ZFCallerInfo(this->_callerFile(), #paramName zfTextA("Set"), this->_callerLine())); \
        zfCoreMutexUnlock(); \
    } \
    T_Owner::paramName##_ZFCoreParam::~paramName##_ZFCoreParam(void) \
    { \
        zfCoreMutexLock(); \
        zflockfree_ZFLeakTestLogBeforeReleaseVerbose(this->value, ZFCallerInfo(this->_callerFile(), #paramName zfTextA(" cleanup"), this->_callerLine())); \
        zflockfree_zfReleaseWithoutLeakTest(this->value); \
        zfCoreMutexUnlock(); \
    } \
    ...
    { \
        zfCoreMutexLock(); \
        zflockfree_zfRetainWithoutLeakTest(ref.value); \
        zflockfree_ZFLeakTestLogAfterRetainVerbose(ref.value, ZFCallerInfo(this->_callerFile(), #paramName zfTextA("Set"), this->_callerLine())); \
        zflockfree_ZFLeakTestLogBeforeReleaseVerbose(this->value, ZFCallerInfo(this->_callerFile(), #paramName zfTextA("Set"), this->_callerLine())); \
        zflockfree_zfReleaseWithoutLeakTest(this->value); \
        zfCoreMutexUnlock(); \
        this->value = ref.value; \
        return *this; \
    ...
    { \
        zfCoreMutexLock(); \
        zflockfree_zfRetainWithoutLeakTest(value); \
        zflockfree_ZFLeakTestLogAfterRetainVerbose(value, ZFCallerInfo(this->paramName##_._callerFile(), #paramName zfTextA("Set"), this->paramName##_._callerLine())); \
        zflockfree_ZFLeakTestLogBeforeReleaseVerbose(this->paramName##_.value, ZFCallerInfo(this->paramName##_._callerFile(), #paramName zfTextA("Set"), this->paramName##_._callerLine())); \
        zflockfree_zfReleaseWithoutLeakTest(this->paramName##_.value); \
        zfCoreMutexUnlock(); \
        this->paramName##_.value = value; \
        return *this; \
