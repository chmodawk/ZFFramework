...
// ============================================================
ZFMETHOD_USER_REGISTER_STATIC_1({return ZFClass::classForName(className);}, v_ZFClass, const ZFClass *, classForName, ZFMP_IN(const zfchar *, className))
ZFMETHOD_USER_REGISTER_STATIC_2({return ZFClass::newInstanceForName(className, callerInfo);}, v_ZFClass, zfautoObject, newInstanceForName, ZFMP_IN(const zfchar *, className), ZFMP_IN_OPT(const ZFCallerInfo &, callerInfo, ZFCallerInfo()))
ZFMETHOD_USER_REGISTER_STATIC_1({return ZFClass::newInstanceForNameWithoutLeakTest(className);}, v_ZFClass, zfautoObject, newInstanceForNameWithoutLeakTest, ZFMP_IN(const zfchar *, className))
ZFMETHOD_USER_REGISTER_STATIC_1({return ZFClass::allClass(ret);}, v_ZFClass, void, allClass, ZFMP_OUT(ZFCoreArray<const ZFClass *> &, ret))
ZFMETHOD_USER_REGISTER_STATIC_0({return ZFClass::allClass();}, v_ZFClass, ZFCoreArrayPOD<const ZFClass *>, allClass)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, void, classDataChangeAutoRemoveTagAdd, ZFMP_IN(const zfchar *, tag))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, void, classDataChangeAutoRemoveTagRemove, ZFMP_IN(const zfchar *, tag))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, void, objectInfoOfInheritTreeT, ZFMP_IN_OUT(zfstring &, ret))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfstring, objectInfoOfInheritTree)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, zfbool, classIsSubclassOf, ZFMP_IN(const ZFClass *, cls))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, zfbool, classIsTypeOf, ZFMP_IN(const ZFClass *, cls))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, const zfchar *, className)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, const ZFClass *, parentClass)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfbool, classIsAbstract)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfbool, classIsInterface)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfbool, classIsPrivate)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfbool, classIsInternal)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, zfautoObject, newInstance, ZFMP_IN_OPT(const ZFCallerInfo &, callerInfo, ZFCallerInfo()))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfautoObject, newInstanceWithoutLeakTest)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfindex, implementedInterfaceCount)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, const ZFClass *, implementedInterfaceAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfindex, methodCount)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, const ZFMethod *, methodAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_8(v_ZFClass, const ZFMethod *, methodForNameIgnoreParent, ZFMP_IN(const zfchar *, methodName)
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_8(v_ZFClass, const ZFMethod *, methodForName, ZFMP_IN(const zfchar *, methodName)
    , ZFMP_IN_OPT(const zfchar *, methodParamTypeId0, zfnull)
    , ZFMP_IN_OPT(const zfchar *, methodParamTypeId1, zfnull)
    , ZFMP_IN_OPT(const zfchar *, methodParamTypeId2, zfnull)
    , ZFMP_IN_OPT(const zfchar *, methodParamTypeId3, zfnull)
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_2(v_ZFClass, void, methodForNameGetAllT, ZFMP_IN_OUT(ZFCoreArray<const ZFMethod *> &, ret), ZFMP_IN(const zfchar *, methodName))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, ZFCoreArrayPOD<const ZFMethod *>, methodForNameGetAll, ZFMP_IN(const zfchar *, methodName))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfindex, propertyCount)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, const ZFProperty *, propertyAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, const ZFProperty *, propertyForNameIgnoreParent, ZFMP_IN(const zfchar *, propertyName))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, const ZFProperty *, propertyForName, ZFMP_IN(const zfchar *, propertyName))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, zfbool, propertyHasOverrideInitStep)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, zfbool, propertyHasOverrideInitStep, ZFMP_IN(const ZFProperty *, property))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_3(v_ZFClass, void, classTagSet, ZFMP_IN(const zfchar *, key), ZFMP_IN(ZFObject *, tag), ZFMP_IN_OPT(zfbool, autoMarkCached, zffalse))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_2(v_ZFClass, void, classTagSetMarkCached, ZFMP_IN(const zfchar *, key), ZFMP_IN(ZFObject *, tag))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, ZFObject *, classTagGet, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_2(v_ZFClass, void, classTagGetAllKeyValue, ZFMP_IN_OUT(ZFCoreArray<const zfchar *> &, allKey), ZFMP_IN_OUT(ZFCoreArray<ZFObject *> &, allValue))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, void, classTagRemove, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFClass, zfautoObject, classTagRemoveAndGet, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFClass, void, classTagRemoveAll)
