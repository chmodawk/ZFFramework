 ...
 */
#define ZFPropertyChange(property, propertyValue) \
    do \
    { \
...
#define zflockfree_ZFPropertyChange(property, propertyValue) \
    do \
    { \
        ZFAny _ZFP_ZFPropertyChangeTmpValue = property; \
        zflockfree_zfRetain(property = propertyValue); \
...
#define ZFPropertyChangeWithoutLeakTest(property, propertyValue) \
    do \
    { \
        ZFAny _ZFP_ZFPropertyChangeTmpValue = property; \
        zfCoreMutexLock(); \
        zflockfree_zfRetainWithoutLeakTest(property = propertyValue); \
...
#define zflockfree_ZFPropertyChangeWithoutLeakTest(property, propertyValue) \
    do \
    { \
        ZFAny _ZFP_ZFPropertyChangeTmpValue = property; \
        zflockfree_zfRetainWithoutLeakTest(property = propertyValue); \
