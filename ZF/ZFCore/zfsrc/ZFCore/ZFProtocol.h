...
#define _ZFP_ZFPROTOCOL_INTERFACE_END(ModuleName) \
    ...
    ZFOUTPUT_TYPE(ZFPROTOCOL_INTERFACE_CLASS(ModuleName), {output << (const ZFProtocol *)&v;}) \
    ZFOUTPUT_TYPE(const ZFPROTOCOL_INTERFACE_CLASS(ModuleName) *, {output << (const ZFProtocol *)v;}) \
    ZFOUTPUT_TYPE(ZFPROTOCOL_INTERFACE_CLASS(ModuleName) *, {output << (const ZFProtocol *)v;})
