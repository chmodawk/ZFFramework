                                      ...
                                      ZF_IN zfbool enableLeakTest)
{
    if(obj)
    {
        _ZFP_zfautoReleaseAction(ZFCastZFObjectUnchecked(ZFObject *, obj), callerInfo, enableLeakTest);
    }
    return obj;
}
                                       ...
                                       ZF_IN zfbool enableLeakTest)
{
    if(obj.toObject())
    {
        _ZFP_zfautoReleaseAction(obj.toObject(), callerInfo, enableLeakTest);
    }
    return obj;
}
template<typename T_ZFObject>
                                                      ...
                                                      ZF_IN zfbool enableLeakTest)
{
    ...
    if(t)
    {
        _ZFP_zfautoReleaseAction(t, callerInfo, enableLeakTest);
    }
    return obj;
}
/**
 ...
 */
#define zfautoRelease(obj) _ZFP_zfautoRelease(obj, ZFCallerInfoMake(), zftrue)
/** @see zfautoRelease */
#define zfautoReleaseWithoutLeakTest(obj) _ZFP_zfautoRelease(obj, ZFCallerInfoMake(), zffalse)
