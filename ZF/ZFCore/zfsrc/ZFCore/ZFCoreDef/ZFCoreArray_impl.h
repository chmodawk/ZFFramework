 ...
 * ====================================================================== */
/**
 * @file ZFCoreArray_impl.h
 * @brief light weight array
 */

#ifndef _ZFI_ZFCoreArray_impl_h_
#define _ZFI_ZFCoreArray_impl_h_
...
template<typename T_Element>
ZFCoreArrayBase *ZFCoreArray<T_Element>::refNew(void) const
{
    return zfnew(ZFCoreArray<T_Element>, *this);
}
template<typename T_Element>
void *ZFCoreArray<T_Element>::refImpl(void) const
{
    return d;
}
template<typename T_Element>
...
template<typename T_Element>
zfindex ZFCoreArray<T_Element>::objectRetainCount(void) const
{
    return d->refCount;
}
template<typename T_Element>
ZFCompareResult ZFCoreArray<T_Element>::objectCompare(ZF_IN const ZFCoreArray<T_Element> &ref,
...
template<typename T_Element>
ZFCoreArrayPOD<T_Element>::ZFCoreArrayPOD(ZF_IN const ZFCoreArray<T_Element> &ref)
: ZFCoreArray<T_Element>(ref)
{
}
template<typename T_Element>
ZFCoreArrayPOD<T_Element> &ZFCoreArrayPOD<T_Element>::operator =(ZF_IN const ZFCoreArray<T_Element> &ref)
{
    ZFCoreArray<T_Element>::operator = (ref);
    return *this;
}
template<typename T_Element>
ZFCoreArrayPOD<T_Element> &ZFCoreArrayPOD<T_Element>::operator =(ZF_IN const ZFCoreArrayPOD<T_Element> &ref)
{
    ZFCoreArray<T_Element>::operator = (ref);
    return *this;
}
...
#endif // #ifndef _ZFI_ZFCoreArray_impl_h_
