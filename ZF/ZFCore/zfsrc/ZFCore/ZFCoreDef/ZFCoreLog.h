 ...
 */
#define zfCoreLog(format, ...) _ZFP_zfCoreLog(ZFCallerInfoMake(), \
    zftrue, format, ##__VA_ARGS__)
/**
 * @brief same as #zfCoreLog except that no '\\n' is added to tail, see #zfCoreLog
 */
#define zfCoreLogNoEndl(format, ...) _ZFP_zfCoreLog(ZFCallerInfoMake(), \
    zffalse, format, ##__VA_ARGS__)

/**
 * @brief log without header info, see #zfCoreLog
 */
#define zfCoreLogTrim(format, ...) _ZFP_zfCoreLog(ZFCallerInfo(), zftrue, format, ##__VA_ARGS__)
/**
 * @brief log without header info or '\\n' to tail, see #zfCoreLog
 */
#define zfCoreLogTrimNoEndl(format, ...) _ZFP_zfCoreLog(ZFCallerInfo(), zffalse, format, ##__VA_ARGS__)
...
#define zfCoreCriticalErrorPrepare() \
    _ZFP_zfCoreCriticalErrorPrepare(ZFCallerInfoMake())
/**
...
#define zfCoreCriticalError() \
    _ZFP_zfCoreCriticalError(ZFCallerInfoMake())
