...
zfclass ZF_ENV_EXPORT ZFUIListCell : zfextends ZFUIView
{
    ...
    ZFPROPERTY_CUSTOM_ON_ATTACH_DECLARE(ZFUIView *, cellView);
    ZFPROPERTY_CUSTOM_ON_DETACH_DECLARE(ZFUIView *, cellView);
    ...
    ZFPROPERTY_CUSTOM_ON_INIT_DECLARE(ZFUIViewLayoutParam *, cellViewLayoutParam)
    {
