...
ZFMETHOD_USER_REGISTER_0({return invokerObject->to<v_ZFTextTemplateIndexData *>()->zfv.indexStart;}, v_ZFTextTemplateIndexData, zfindex, indexStart)
ZFMETHOD_USER_REGISTER_0({return invokerObject->to<v_ZFTextTemplateIndexData *>()->zfv.indexOffset;}, v_ZFTextTemplateIndexData, zfindex, indexOffset)
ZFMETHOD_USER_REGISTER_0({return invokerObject->to<v_ZFTextTemplateIndexData *>()->zfv.indexRadix;}, v_ZFTextTemplateIndexData, zfindex, indexRadix)
ZFMETHOD_USER_REGISTER_0({return invokerObject->to<v_ZFTextTemplateIndexData *>()->zfv.indexUpperCase;}, v_ZFTextTemplateIndexData, zfbool, indexUpperCase)
ZFMETHOD_USER_REGISTER_0({return invokerObject->to<v_ZFTextTemplateIndexData *>()->zfv.indexWidth;}, v_ZFTextTemplateIndexData, zfindex, indexWidth)
ZFMETHOD_USER_REGISTER_0({return invokerObject->to<v_ZFTextTemplateIndexData *>()->zfv.indexFlag;}, v_ZFTextTemplateIndexData, ZFTextTemplateIndexFlagEnum, indexFlag)
...
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_2(v_ZFTextTemplateParam, void, replaceDataAdd, ZFMP_IN(const zfchar *, key), ZFMP_IN(const zfchar *, value))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const zfchar *, replaceData, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, zfindex, replaceDataCount)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const zfchar *, replaceDataNameAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const zfchar *, replaceDataAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, replaceDataRemove, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, replaceDataRemoveAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, void, replaceDataRemoveAll)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, enableDataDefaultSet, ZFMP_IN(zfbool, enableDataDefault))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, zfbool, enableDataDefault)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_2(v_ZFTextTemplateParam, void, enableDataAdd, ZFMP_IN(const zfchar *, key), ZFMP_IN(zfbool, value))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const zfbool *, enableData, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, zfbool, enableDataValue, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, zfindex, enableDataCount)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const zfchar *, enableDataNameAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, zfbool, enableDataAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, enableDataRemove, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, enableDataRemoveAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, void, enableDataRemoveAll)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, indexDataDefaultSet, ZFMP_IN(const ZFTextTemplateIndexData &, indexDataDefault))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, const ZFTextTemplateIndexData &, indexDataDefault)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_2(v_ZFTextTemplateParam, void, indexDataAdd, ZFMP_IN(const zfchar *, key), ZFMP_IN(const ZFTextTemplateIndexData &, value))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const ZFTextTemplateIndexData *, indexData, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, zfindex, indexDataCount)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const zfchar *, indexDataNameAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, const ZFTextTemplateIndexData *, indexDataAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, indexDataRemove, ZFMP_IN(const zfchar *, key))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, indexDataRemoveAtIndex, ZFMP_IN(zfindex, index))
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_0(v_ZFTextTemplateParam, void, indexDataRemoveAll)
ZFMETHOD_USER_REGISTER_FOR_WRAPPER_1(v_ZFTextTemplateParam, void, copyFrom, ZFMP_IN(const ZFTextTemplateParam &, ref))
