...
LIBS += -L$$ZF_ROOT_PATH/_release/$$_ZF_QT_TYPE/all/lib -lZFLua
macx {QMAKE_POST_LINK += install_name_tool -change "libZFLua.1.dylib" "@rpath/libZFLua.dylib" $$system_path($$OUT_PWD/lib$${ZF_PROJ_NAME}.dylib) $$escape_expand(\\n\\t)}
