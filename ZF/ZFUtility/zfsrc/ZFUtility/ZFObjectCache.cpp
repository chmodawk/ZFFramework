...
ZF_GLOBAL_INITIALIZER_INIT_WITH_LEVEL(ZFObjectCacheDataHolder, ZFLevelZFFrameworkEssential)
{
...
// ============================================================
ZFPROPERTY_CUSTOM_ON_UPDATE_DEFINE(ZFObjectCache, zfbool, cacheTrimWhenReceiveMemoryWarning)
{
